...
//PersonaServices servicio;
    ...
    @GetMapping("") //para buscar por algo (por nombre, por apellido)
  // el ? es un comodin generico, puede devolver cualquier cosa
    public ResponseEntity<?> getAll(){
        try{
            return ResponseEntity.status(HttpStatus.OK).
                    body("Busqué todos los datos");
        }
        catch (Exception e){ //condicion de error, la devuelde en formato JSON
    ...
    @PostMapping("") //atrapa el body del formualario, se estan transmitiendo json
    //request body
    ...
    @PutMapping("/{id}") //es la actualizacion
